...
},{"backbone":3,"backbone.radio":2,"underscore":24}],2:[function(require,module,exports){
...
},{"backbone":3,"underscore":24}],3:[function(require,module,exports){
(function (global){
//     Backbone.js 1.3.3
...
},{"jquery":23,"underscore":24}],4:[function(require,module,exports){
'use strict';
...
var AlbumRouter, Backbone, Layout, Marionette, PayeverApp;
...
PayeverApp = Marionette.Application.extend({
  ...
  onStart: function() {
    ...
    main = this.getRegion();
    main.show(layout);
    this.ac = new AlbumRouter.controller({
      layout: layout
    });
...
},{"../models/album":29,"backbone":3}],27:[function(require,module,exports){
var Backbone, Image, ImageList;
...
},{"../models/image":30,"backbone":3}],28:[function(require,module,exports){
var app;
...
},{"./app":25}],29:[function(require,module,exports){
var Album, Backbone;
...
},{"backbone":3}],30:[function(require,module,exports){
var Backbone, Image;
...
},{"backbone":3}],31:[function(require,module,exports){
var AlbumController, AlbumListCollection, AlbumListCollectionView, AlbumListControlsView, AlbumRouter, Backbone, ErrorPage, ImageCollection, ImageCollectionView, ImageControlsView, Marionette;
...
AlbumController = Marionette.Object.extend({
  ...
  addAlbum: function(album) {
    if (this.albumList && album) {
      return this.albumList.add(album);
    }
  },
...
AlbumRouter = Marionette.AppRouter.extend({
  ...
  onRoute: function(name, path, args) {
    return console.log('User navigated to ', name, path);
  }
});
...
var templater = require("handlebars/runtime")["default"].template;module.exports = templater({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"square-img-cont\">\n	<div class=\"d\"></div>\n	<div class=\"c\">\n		<img src=\""
...
},{"handlebars/runtime":22}],33:[function(require,module,exports){
var templater = require("handlebars/runtime")["default"].template;module.exports = templater({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<form method=\"POST\">\n	<h3><label for=\"newAlbumName\">Create new album</label></h3>\n	<input id=\"newAlbumName\" class=\"form-def\" type=\"text\" name=\"name\" value=\"\" placeholder=\"Type album name\" />\n	<button type=\"submit\" class=\"btn-main\">create</button>\n</form>";
},"useData":true});
},{"handlebars/runtime":22}],34:[function(require,module,exports){
var templater = require("handlebars/runtime")["default"].template;module.exports = templater({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div class=\"error_page\">\n    <h1>Page not found</h1>\n    <p>\n        Please go to the <a href=\"/\">home page</a>\n    </p>\n</div>";
},"useData":true});
},{"handlebars/runtime":22}],35:[function(require,module,exports){
var templater = require("handlebars/runtime")["default"].template;module.exports = templater({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div class=\"error_page\">\n    <h1>Something wrong</h1>\n    <p>\n        Try to open <a href=\"/\">homepage</a>\n    </p>\n</div>";
},"useData":true});
},{"handlebars/runtime":22}],36:[function(require,module,exports){
var templater = require("handlebars/runtime")["default"].template;module.exports = templater({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<input id=\"upload-img\" type=\"file\" name=\"img\">\n<button type=\"button\" class=\"btn-main\">Upload</button> <span>new image</span>";
},"useData":true});
},{"handlebars/runtime":22}],37:[function(require,module,exports){
var templater = require("handlebars/runtime")["default"].template;module.exports = templater({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<h3>Album is empty</h3>";
},"useData":true});
},{"handlebars/runtime":22}],38:[function(require,module,exports){
var templater = require("handlebars/runtime")["default"].template;module.exports = templater({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var helper;
...
Album = Marionette.View.extend({
  ...
  openAlbum: function(event) {
    Backbone.history.navigate('/album/' + this.model.get('id'), {
      trigger: true
    });
...
Controls = Marionette.View.extend({
  ...
  submit: function(event) {
    ...
    album.save({}, {
      success: function() {
        return notifyChannel.trigger('add:album', album);
      },
      error: function() {
        return console.error('Something wrong. Can\'t save album');
      }
    });
    return this.ui.aname.val('');
  }
});
...
ErrorPage = Marionette.View.extend({
  initialize: function(options) {
    switch (options.page.toString()) {
      case '404':
        return this.template = E404;
      default:
        return this.template = E500;
    }
  },
  events: {
    'click a': 'redirect'
...
Controls = Marionette.View.extend({
  ...
  changeFile: function(event) {
    console.log('@ui.file', this.ui.file);
    return this.ui.file.click();
  },
  fileIsChanged: function(event) {
    var album, data, file, input, ref;
    input = event.target;
    file = input.files[0];
    if ((ref = file.type) !== "image/jpeg" && ref !== "image/png") {
    ...
    return $.ajax({
      ...
      success: function(data, textStatus, jqXHR) {
        ...
        return notifyChannel.trigger('add:image', image);
      },
      error: function(jqXHR, textStatus, errorThrown) {
        return console.log('ERRORS: ' + textStatus);
      }
    });
  }
});
